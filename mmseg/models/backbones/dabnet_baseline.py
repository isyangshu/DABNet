...
class DABNet_baseline(BaseModule):
    """BiSeNetV1 backbone.
    ...
    def __init__(self,
        ...
        super(DABNet_baseline, self).__init__(init_cfg=init_cfg)
        ...
        self.sp_0 = ConvModule(in_channels=in_channels,
        ...
        self.sp_1 = ConvModule(in_channels=spatial_channels[0],
        ...
        self.sp_2 = ConvModule(in_channels=spatial_channels[1],
        ...
        self.sp_3 = ConvModule(in_channels=spatial_channels[2],
                                 out_channels=spatial_channels[3],
                                 kernel_size=1,
                                 stride=1,
                                 padding=0,
    ...
    def forward(self, img):
        ...
        x_spatial = self.sp_0(img)  # N, 64, 512, 512
        x_spatial = self.sp_1(x_spatial)  # N, 64, 256, 256
        x_spatial = self.sp_2(x_spatial)  # N, 64, 128, 128
        x_spatial = self.sp_3(x_spatial)  # N, 128, 128, 128
