...
class DABNet_Ef(BaseModule):
    ...
    def __init__(self,
        ...
        super(DABNet_Ef, self).__init__(init_cfg=init_cfg)
        ...
        norm = NORM_LAYERS.get(norm_name)
        self.backbone = timm.create_model(model_name='efficientnet_b1', features_only=True, pretrained=True, norm_layer=norm)
        ...
        self.SIM_0 = SIM(24, 24, norm_name)  # SyncBN
        self.SIM_1 = SIM(40, 32, norm_name)
        self.SIM_2 = SIM(112, 32, norm_name)
        self.SIM_3 = SIM(320, 32, norm_name)
    ...
    def forward(self, img):
        ...
        x_2 = self.backbone.conv_stem(img)
        x_2 = self.backbone.bn1(x_2)
        x_2 = self.backbone.act1(x_2)
        x_2 = self.backbone.blocks[0](x_2)

        x_4 = self.backbone.blocks[1](x_2)
        x_4 = self.SIM_0(x_4)  # N， 24， 256， 256

        x_8 = self.backbone.blocks[2](x_4)  # N, 40, 128, 128
        x_8 = self.SIM_1(x_8)

        x_16 = self.backbone.blocks[3](x_8)  # N, 112, 64, 64
        x_16 = self.backbone.blocks[4](x_16)
        x_16 = self.SIM_2(x_16)

        x_32 = self.backbone.blocks[5](x_16)  # N, 320, 32, 32
        x_32 = self.backbone.blocks[6](x_32)
        x_32 = self.SIM_3(x_32)
